...
For complete API documentation including all endpoints, request/response schemas, WebSocket interface, and usage examples, refer to the **[API Reference Documentation](./app/docs/API_REFERENCE.md)**.
